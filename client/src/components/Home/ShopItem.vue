<template>
  <section class="shop-item" @click.stop="gotoShop(data._id)">
    ...
    <div class="shop-info">
      <div class="logo">
        <img v-lazy="IMAGE_URL + data.avatar_image" :key="IMAGE_URL + data.avatar_image" alt="">
        <!-- <img v-lazy="IMAGE_URL + data.avatar_image" alt=""> -->
        <!-- <img :src="IMAGE_URL + data.avatar_image" alt=""> -->
...
export default class ShopItem extends Vue {
  ...
  mounted () {
    console.log("src/home/shopitem------>this.IMAGE_URL")
    console.log(this.IMAGE_URL)
    console.log("src/home/shopitem------>this.data")
