  ...
  <div class="shop" :class="activeName !== 'FoodNav'?'autoheight':''" ref="shopScroll">
    ...
    <div class="tab-box" ref="vtabs">
      <van-tabs v-model="activeName" class="tab">
        ...
        <van-tab title="评价" name="FoodComments"></van-tab>
    ...
    <div class="content" :style="{
      ...
      <FoodComments :height="height" :data="data" v-if="activeName === 'FoodComments'"/>
...
import FoodComments from '@/components/Shop/foodcomments.vue'
...
export default class Shop extends Vue {
  ...
  async getShopInfo () {
    ...
    console.log("shop.vue----->shopinfoData")
    console.log(data)
    if (!data) {
      this.noid = true
      return
