<template>
    <div class="home-page" ref="home" @scroll="scroll" :class="notScroll?'notScroll':''">
        <HomeHeader @goto="gotoAddressDetail">{{ location.name }}</HomeHeader>
        <SearchLinker v-if="headerFixed" @goto="gotoAddressDetail"></SearchLinker>
...
import SearchLinker from '@/components/Home/SearchLinker.vue'
