...
export const getSms = async ({ctx, phone}: any) => {
  try {
    ...
    // console.log("/controller/api/index.ts------>ctx.session.logininfo")
    // console.log(ctx.session.logininfo)
    // console.log("/controller/api/index.ts------>ctx.session")
...
export const loginManage = async ({ sms, phone, ctx }: any) => {
  console.log("/controller/api/index.ts------>sms,phone")
  console.log(sms)
  console.log(phone)
  if (phone&&sms) {
    // console.log("/controller/api/index.ts------>ctx.session")
    ...
    if (ctx.session&&ctx.session.logininfo) {
      if (ctx.session.logininfo.sms === sms&&ctx.session.logininfo.phone===phone) {
        ...
        console.log("/controller/api/index.ts------>queryPhoneGetUser result")
        console.log(result)
        if (result) {
          ctx.session.userinfo = result
          console.log("/controller/api/index.ts------>ctx.session.logininfo_olduser")
          ...
          console.log("/controller/api/index.ts------>ctx.session.logininfo_newuser")
          console.log(ctx.session.userinfo)
...
//       if (ctx.session.logininfo.sms === sms&&ctx.session.logininfo.phone===phone) {
//         let result = await queryPhoneGetUser(phone)
//         console.log("/controller/api/index.ts------>result")
//         console.log(result)
//         if (result) {
//           ctx.session.userinfo = result
//           return new SuccessModel(result)
