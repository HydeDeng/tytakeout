...
let specSchema = new Schema({
  ...
  shop_id: { type: Schema.Types.ObjectId, isRequired: true }, // 所属餐馆
  foodcate_id: { type: Schema.Types.ObjectId, isRequired: true }, // 所属食品分类
  ...
  food_id: { type: Schema.Types.ObjectId, isRequired: true }, // 所属食品
