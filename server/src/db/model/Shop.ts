...
let shopSchema = new Schema({
  ...
  rating_food: { type: Number, default: 5.0 }, // 评分
  rating_pack: { type: Number, default: 5.0 }, // 评分
  rating_delivery: { type: Number, default: 5.0 }, // 评分
  rating_count: { type: Number, default: 0 }, // 评分人数
